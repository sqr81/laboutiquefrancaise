...
class OrderCrudController extends AbstractCrudController
{
    ...
    private $crudUrlGenerator;//pour traiter l'url de redirection apres le traitement de la fonction update
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            //BooleanField::new('isPaid', 'Payée'), //isPaid remplacé par state
